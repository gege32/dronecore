...
void MPU6050_init(MPU6050Init_TypeDef* MPU6050_InitStruct) {
	...
	//set gyro resolution
	I2C_SetBits(&MPU6050_Settings->I2C_Device, MPU6050_FS_SEL_8G, MPU6050_GYRO_CONFIG);

	//set accel resolution
	I2C_SetBits(&MPU6050_Settings->I2C_Device, MPU6050_FS_SEL_2000, MPU6050_ACCEL_CONFIG);
}
